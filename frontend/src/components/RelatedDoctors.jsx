...
const RelatedDoctors = ({docId, speciality}) => {
  ...
  useEffect(() => {
    if(doctors.length >0 && speciality){
      const doctorsData = doctors.filter((doc)=> doc.speciality === speciality && doc._id.toString() !== docId)
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>These are the best Doctors</p>
